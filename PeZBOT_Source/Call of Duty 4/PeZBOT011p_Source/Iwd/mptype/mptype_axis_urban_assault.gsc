...
precache()
{
	...
	character\character_mp_opforce_urban_ghillie::precache();
	character\character_mp_opforce_urban_al_asad::precache();
	character\character_mp_opforce_urban_zakhaev::precache();
	character\character_mp_opforce_urban_farmer::precache();
